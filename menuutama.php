...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="card shadow text-white" style="background-color: #222e3c;">
            ...
            <div class="col-lg-6">
                <div class="card mb-3 clickable-card shadow text-white" onclick="location.href='opname.php'" style="cursor: pointer; background-color: #222e3c;">
                    <div class="card-body">
                ...
                <div class="card mb-3 clickable-card shadow text-white" onclick="location.href='masuk.php'" style="cursor: pointer; background-color: #222e3c;">
                    <div class="card-body">
                ...
                <div class="card clickable-card shadow text-white" onclick="location.href='keluar.php'" style="cursor: pointer; background-color: #222e3c;">
                    <div class="card-body">
